      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-display font-bold text-slate-900 dark:text-white mb-6">
            Fasilitas Lengkap Dealer BYD Jakarta
          </h2>
          <p className="text-gray-600 dark:text-gray-400">
            Kami tidak hanya menjual mobil. Sebagai dealer 3S, BYD Jakarta menjamin ketenangan pikiran Anda dengan layanan purna jual berstandar global di lokasi kami yang nyaman.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl border border-gray-100 dark:border-slate-700 hover:border-teal-500 transition-colors group">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
              Konsultasi produk profesional, simulasi kredit fleksibel, dan ketersediaan unit (Ready Stock) BYD Seal, Atto 3, Dolphin, dan M6 untuk wilayah Jakarta dan sekitarnya.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl border border-gray-100 dark:border-slate-700 hover:border-teal-500 transition-colors group">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
              Teknisi tersertifikasi BYD Global di Bengkel Resmi Jakarta, peralatan diagnostik canggih, dan fasilitas Body Repair untuk menjaga performa mobil listrik Anda.
            </p>
          </div>
