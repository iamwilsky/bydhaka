        ...
        '@graph': [
            {
                ...
                image: `https://bydhaka.com${variant.imageUrl || model.heroImage}`,
                ...
                offers: {
                    '@type': 'Offer',
                    url: `https://bydhaka.com/variant/${model.id}/${variant.id}`,
                    priceCurrency: 'IDR',
                    price: variant.price,
            ...
            },
            {
                ...
                itemListElement: [
                    ...
                    },
                    {
                        ...
                        position: 3,
                        name: `${model.name} ${variant.name}`,
                        item: `https://bydhaka.com/variant/${model.id}/${variant.id}`,
                    },
                ],
            },
        ],
